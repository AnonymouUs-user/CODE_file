...
with open(pjoin('../data/MMEA-data/seed0.5', 'FB15K-DB15K', 'sup_ent_ids'), 'r') as f:
    for line in f:
        line = line.strip()
        ent_id1, ent_id2 = line.split()
        train_pair.append((int(ent_id1), int(ent_id2)))

with open(pjoin('../data/MMEA-data/seed0.5', 'FB15K-DB15K', 'dev_ent_ids'), 'r') as f:
    for line in f:
        line = line.strip()
        ent_id1, ent_id2 = line.split()
        dev_pair.append((int(ent_id1), int(ent_id2)))

# with open(pjoin('../data/MMEA-data/seed0.5', 'FB15K-DB15K', 'attr'), 'r') as f:
