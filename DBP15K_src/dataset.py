...
class DBPDataset():
    def __init__(self, file_path, device):
        ...
        # self.train_pair = self.pair_trans_by_index(self.train_pair, self.index_1, self.index2)
        # self.test_pair = self.pair_trans_by_index(self.test_pair, self.index_1, self.index2)
